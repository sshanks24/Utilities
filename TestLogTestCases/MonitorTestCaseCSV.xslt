<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:variable name="GDDSNMPPoint" select="document('PM4_SNMP.xml')//GDD_POINT"/>
	<xsl:variable name="deviceName">PM4</xsl:variable>
	<xsl:variable name="tabName">Monitor</xsl:variable>
	<xsl:variable name="idPrefix">812.10.</xsl:variable>
